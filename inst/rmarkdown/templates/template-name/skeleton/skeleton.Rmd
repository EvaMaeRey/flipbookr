...
`r apply_reveal("cars", break_type = "auto")`
...
`r apply_reveal("cars", break_type = "user")`
...
`r apply_reveal("cars", break_type = "non_seq")`
...
`r apply_reveal("reg_assign_example", break_type = "auto", display_type = "both", reg_assign = T)`


```{r reg_assign_example, echo = F, eval = T}
...
<!-- r apply_reveal("calc_panes")` -->


<!-- ```{r calc_panes, eval = F, echo = F} -->
<!-- flipbookr:::local_code %>% -->
<!--   parse_code() %>% -->
...
<!-- `r apply_reveal("return_partial_code")` -->

<!-- ```{r return_partial_code, eval = F, echo = F} -->
<!-- flipbookr:::local_code %>% -->
<!--   parse_code() %>%  -->
<!--   partial_code(which_show = 1:5, which_highlight = 5) -->
<!-- ``` -->
...
<!-- Sequential workflow that provides feedback and reassurance.  -->
