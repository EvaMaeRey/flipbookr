...
The default is `display_type = c("code", "output")` which will give you the classic flipbook --- code and output co-evolution.
...
`r chunk_reveal("cars", display_type = "output")`
...
`r chunk_reveal("cars", display_type = "code")`
...
`r chunk_reveal("boring", break_type = "auto", display_type = c("code", "output", "output_lag"), widths = c(1,1,1))`
...
The length of the md vector will likely be the same length as the slides in the flipbook.
...
`r chunk_reveal("cars3", title = "## Using a title and custom widths", widths = c(24, 75))`
...
# quickly chance font size of code
.remark-code{line-height: 1.5; font-size: 80%}


# this bit is with a mind to converting to pdf or gif
@media print {
  .has-continuation {
    display: block;
  }
