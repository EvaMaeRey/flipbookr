...
## break_type = "replacement" (with injection argument)
...
`r chunk_reveal("for_loop", break_type = "replacement", replacements = 1:4, replace = "10", replacements2 = 5:8, replace2 = "500")`
...
`r chunk_reveal("palettes", break_type = "replacement", replacements = c("cadetblue", "darkolivegreen", "firebrick2", "firebrick"), replace = "orange", my.fig.width = "8")`
...
`r chunk_reveal("table_formatting", break_type = "auto", display_type = c("code", "output"), left_assign = TRUE, table_formatting = "data.frame")`
