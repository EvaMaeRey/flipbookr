...
`r chunk_reveal("top_bottom", title = "## Using a title and custom widths", widths = c(24, 75), float = "top")`
...
# library needs to be loaded, no double colons
library(gt)
```
...
`r chunk_reveal("table_formatting", break_type = "auto", display_type = c("code", "output"), left_assign = TRUE, table_formatting = "gt")`
